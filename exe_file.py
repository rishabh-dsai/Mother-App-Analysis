...
hiv_test_trend=pd.read_excel("Datasets/HIV test trend.xlsx")
vdrl_test_trend=pd.read_excel("Datasets/VDRL test trend.xlsx")
...
asha_visits=pd.read_excel("Datasets/Number of ASHA visits prior to delivery_delivered_1_tri.xlsx")
asha_visits.set_index('Home visits done by the ANM ASHA  prior to delivery',inplace=True)
